...
int main(int argc, char **argv) {
    ...
    assert(!groundtruth.empty() && !estimated.empty()); // check if the files are not empty
    assert(groundtruth.size() == estimated.size()); // check if the records have the same length
