...
public:
    ...
    /// the initial address of the camera parameters
...
private:
    ...
    int *point_index_;          // the corresponding point index for each observation
    int *camera_index_;         // the corresponding camera index for each observation
