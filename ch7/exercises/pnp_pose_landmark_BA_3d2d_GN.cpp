...
int main(int argc, char **argv) {
    ...
    Sophus::SE3d pose_gn; // using an identity matrix as initial guess
    ...
    bundleAdjustmentGaussNewton(pts_3d_eigen, pts_2d_eigen, K, pose_gn, pts_3d_ba);
